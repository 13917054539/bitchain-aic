...
import cn.ztuo.bitrade.job.MemberStatisticsJob;
...
private KafkaTemplate kafkaTemplate ;
	...
	public void test() throws Exception {
		int i = new BigDecimal("0.0995000000000000").compareTo(new BigDecimal("0.0995"));
		System.out.println("qweqw"+i);
	}
	...
	public void testPermissions(){
		...
		for (Member member:content){
			...
			member.setPhone(member1.getMobilePhone());
		}
	...
	@Test
	public void testPermisons(){
		List<cn.ztuo.bitrade.entity.Member> all = memberDao.test();
		for (cn.ztuo.bitrade.entity.Member member:all){
			...
			wallet.setCtoquota(new BigDecimal(0));
