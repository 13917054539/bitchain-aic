...
public class SmsController {
    ...
    public static final String FREQUENTLY_REQUEST = "FREQUENTLY_REQUEST";
    @Autowired
...
//            Assert.isTrue(Validator.isMobile(phone.trim()), localeMessageSourceService.getMessage("PHONE_EMPTY_OR_INCORRECT"));
