...
import static cn.ztuo.bitrade.constant.TransactionType.ACTIVITY_AWARD;
...
public class MemberService extends BaseService {
    ...
    public Member login(String username, String password) throws Exception {
        ...
        //  System.out.println(Md5.md5Digest(password + member.getSalt()));
        if (member == null) {
     ...
     * @return
     */
    public Integer getCountDirectpush(long memberId){
        return memberDao.getCountDirectpush(memberId);
    }
     ...
     * @return
     */
    public Integer getCountTeam(long memberId){
        return memberDao.getCountTeam(memberId);
    }
