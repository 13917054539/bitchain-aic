...
public class MemberWallet {
     ...
     * 可转换
     */
    @Column(columnDefinition = "decimal(18,8) comment '可转换'")
    private BigDecimal convertible;

    /**
     * 可转额度
     */
    @Column(columnDefinition = "decimal(18,8) comment '可转额度'")
    private BigDecimal convertiblequota;

    /**
     * CTO额度
     */
    @Column(columnDefinition = "decimal(18,8) comment 'CTO额度'")
    private BigDecimal ctoquota;
