...
public class Member {
    ...
    /**
     * vip级别分别是 0 普通用户 1 实名用户 2 有效用户 3 VIP0
     */
    @Column(name = "vip")
    private Integer vip;

    @Column(name = "zhituinum")
    ...
    @Column
    private BigDecimal aiosLimit;
    @Column
    private Integer  robotStatus;
    @Column
    private BigDecimal robotLimit;

    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
    private Date robotOpenTime;

    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
    private Date robotCloseTime;
