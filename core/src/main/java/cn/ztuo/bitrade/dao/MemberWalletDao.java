...
public interface MemberWalletDao extends BaseDao<MemberWallet> {
    ...
    @Modifying
    @Query("update MemberWallet wallet set wallet.toReleased = wallet.toReleased - :amount,wallet.balance = wallet.balance + :amount where wallet.id = :walletId")
    int increaseBalanceAndToReleased(@Param("walletId") long walletId, @Param("amount") BigDecimal amount);
    ...
    MemberWallet findByCoinAndAddressOrAddressEth(Coin coin, String address,String addressEth);

    MemberWallet findByCoinAndMemberId(Coin coin, Long memberId);

    List<MemberWallet> findAllByMemberId(Long memberId);

    List<MemberWallet> findAllByMemberIdOrderByVersionDesc(Long memberId);
    List<MemberWallet> findAllByMemberIdOrderByVersionDesc(Long memberId, Sort sort);
...
//    int initSuperPaterner(@Param("memberId") long memberId);
     ...
     * @return:
     */
    @Query(value = "select * from member_wallet where to_released>0 AND  coin_id!='CMB'",nativeQuery =true)
    List<MemberWallet> allMemberWallet();
    ...
    int increaseToReleased(@Param("walletId") long walletId, @Param("amount") BigDecimal amount);
     ...
     */
    @Modifying
    @Query("update MemberWallet wallet set wallet.toReleased = wallet.toReleased - :amount where wallet.id = :walletId and wallet.toReleased >= :amount")
    int decreaseToReleased(@Param("walletId") long walletId, @Param("amount") BigDecimal amount);
     ...
     * @return:
     */
    @Query(value = "select * from member_wallet where member_id=:id AND coin_id='CMB'",nativeQuery =true)
    MemberWallet memberWalletCmb(@Param("id")long id);
     ...
     */
    @Modifying
    @Query("update MemberWallet wallet set wallet.convertible = wallet.convertible + :amount where wallet.id = :walletId")
    int increaseConvertible(@Param("walletId") long walletId, @Param("amount") BigDecimal amount);
     ...
     */
    @Modifying
    @Query("update MemberWallet wallet set wallet.convertible = wallet.convertible - :amount where wallet.id = :walletId and wallet.convertible >= :amount")
    int decreaseConvertible(@Param("walletId") long walletId, @Param("amount") BigDecimal amount);
     ...
     */
    @Modifying
    @Query("update MemberWallet wallet set wallet.convertiblequota = wallet.convertiblequota + :amount where wallet.id = :walletId")
    int increaseConvertiblequota(@Param("walletId") long walletId, @Param("amount") BigDecimal amount);
     ...
     */
    @Modifying
    @Query("update MemberWallet wallet set wallet.convertiblequota = wallet.convertiblequota - :amount where wallet.id = :walletId and wallet.convertiblequota >= :amount")
    int decreaseConvertiblequota(@Param("walletId") long walletId, @Param("amount") BigDecimal amount);
     ...
     * @return:
     */
    @Query(value = "select * from member_wallet where member_id=:id AND coin_id='USDT'",nativeQuery =true)
    MemberWallet memberWalletUsdt(@Param("id")long id);
     ...
     * @return:
     */
    @Query(value = "select * from member_wallet where member_id=:id AND coin_id='CTO'",nativeQuery =true)
    MemberWallet memberWalletCto(@Param("id")long id);
     ...
     */
    @Modifying
    @Query("update MemberWallet wallet set wallet.ctoquota = wallet.ctoquota + :amount where wallet.id = :walletId")
    int increaseCtoquota(@Param("walletId") long walletId, @Param("amount") BigDecimal amount);
     ...
     */
    @Modifying
    @Query("update MemberWallet wallet set wallet.ctoquota = wallet.ctoquota - :amount where wallet.id = :walletId and wallet.ctoquota >= :amount")
    int decreaseCtoquota(@Param("walletId") long walletId, @Param("amount") BigDecimal amount);
